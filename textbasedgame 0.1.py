...
weapons = [
            "wooden_sword","bronze_sword","copper_sword","iron_sword","steel_sword", "obsidansteel_sword","bluesteel_sword"
            ]
armors = [
        "leather_armor","copper_armor", "bronze_armor", "iron_armor", "steel_armor", "obsidansteel_armor", "knight_armor","bluesteel_armor"
         ]
...
print("version 0.1 ALPHA, EXPECT BUGS")
...
def statupdateweapon():
    ...
    if weapon == "wooden_sword":
        ...
        weaponstats = [15,0.8]
    elif weapon == "obsidansteel_sword":
        weaponstats = [20,0.8]
    textgame()
...
def textgame():
    ...
    if action == "help":
        ...
        if craftingrequest == "copper":
            ...
            print("to craft, type the refined material name, such as copper/bronze/iron/steel/bluesteel/obsidansteel etc, to craft weapons use _sword as the ending, to craft armor use _armor as the ending")
            textgame()
